...
//        }
//        return new HoloInjector(new RoboguiceContextWrapper(context), Guice.createInjector(module));
//    }
//
//    @SuppressWarnings("unchecked")
...
//        AddonRoboguiceA addon = activity.addon(AddonMyRoboguice.class);

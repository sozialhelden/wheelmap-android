...
public class WheelchairToiletStateFragment extends WheelchairStateFragment {

    public static final String TAG = WheelchairToiletStateFragment.class
            .getSimpleName();

    public static WheelchairToiletStateFragment newInstance(WheelchairFilterState state) {
        Bundle b = new Bundle();
        b.putInt(Extra.WHEELCHAIR_TOILET_STATE, state.getId());
        WheelchairToiletStateFragment f = new WheelchairToiletStateFragment();
        f.setArguments(b);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_wheelchair_toilet_state,
                container, false);

        mRadioButtonsMap.put(WheelchairFilterState.TOILET_YES,
                (RadioButton) v.findViewById(R.id.radio_enabled));
        mRadioButtonsMap.put(WheelchairFilterState.TOILET_NO,
                (RadioButton) v.findViewById(R.id.radio_disabled));
        mRadioButtonsMap.put(WheelchairFilterState.TOILET_UNKNOWN,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        int newStateInt = getArguments().getInt(Extra.WHEELCHAIR_TOILET_STATE,
                Extra.UNKNOWN);
    ...
    protected WheelchairFilterState getWheelchairState() {
        ...
        return WheelchairFilterState.TOILET_UNKNOWN;
    }
}

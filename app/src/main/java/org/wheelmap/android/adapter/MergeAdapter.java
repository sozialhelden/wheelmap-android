 ...
 *
 * Adapters used as pieces within MergeAdapter must have view type IDs monotonically increasing from
 * 0. Ideally, adapters also have distinct ranges for their row ids, as returned by getItemId().
 */

 ...
 *
 * If you supply a list of views in the constructor, that list will be used directly. If any
 * elements in the list are null, then newView() will be called just for those slots.
 *
 ...
 * like a list. This is particularly useful if you combine this with other adapters (e.g.,
 * SectionedAdapter) that might have an arbitrary number of rows, so it all appears seamless.
 */
public class SackOfViewsAdapter extends BaseAdapter {
    ...
    /**
     * Constructor creating an empty list of views, but with a specified count. Subclasses must
     * override newView().
     */
    ...
    /**
     * Constructor wrapping a supplied list of views. Subclasses must override newView() if any of the
     * elements in the list are null.
     */

...
/**
 * Constructs the Uri of a <code>/api/categories/1/nodes/search?api_key=&q=&bbox=&wheelchair=</code>
 * request
 *
...
public class CategoryNodesRequestBuilder extends BaseNodesRequestBuilder {
    ...
    public CategoryNodesRequestBuilder(final String server, final String apiKey,
            final AcceptType acceptType, int category, String searchTerm) {
    ...
    protected String resourcePath() {
        return String.format(Locale.US, RESOURCE, category);
    }

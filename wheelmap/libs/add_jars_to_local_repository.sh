...
mvn install:install-file -Dfile=pulltorefresh-library-1.2.8.jar -DgroupId=org.wheelmap.android \
    -DartifactId=pulltorefresh-library -Dversion=1.2.8 -Dpackaging=jar

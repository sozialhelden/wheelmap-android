...
public class POIsCursorOsmdroidOverlay extends ItemizedOverlay<OverlayItem> {
	...
	public POIsCursorOsmdroidOverlay(Context context, OnTapListener listener) {
		super(WheelmapApp.getSupportManager().getDefaultOverlayDrawable(), new DefaultResourceProxyImpl(context));
		mContext = context;
	...
	protected void onDrawItem( Canvas canvas, OverlayItem item, Point curScreenCoords, Matrix canvasMatrix ) {
